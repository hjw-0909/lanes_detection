"""
    config file of the large version of CondLaneNet for curvelanes
"""
# global settings
dataset_type = 'CurvelanesDataset'
data_root = "/mnt/data-2/data/peng.li/data/public_dataset/curvelanes-orig/Curvelanes"
# data_root = "/mnt/cfs/algorithm/peng.li/data/phigent_vehicle_collect/22526/images/"
test_mode = False
mask_down_scale = 4
hm_down_scale = 16
mask_size = (1, 80, 200)
...
log_level = 'INFO'
work_dir = './work_dirs/exps/curvelanes/large'
load_from = None
resume_from = None
